                    ...
                    <div class="card mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="phone_type" id="phone_type" value="{{ $restInfo->phone_type }}" class="form-control" placeholder="Phone Type">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="job_apply" id="job_apply" value="{{ $restInfo->job_apply }}" class="form-control" placeholder="Job Apply">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="email" name="system_email" id="system_email" value="{{ $restInfo->system_email }}" class="form-control" placeholder="System Email">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="bank_in_vn" id="bank_in_vn" class="form-control">
                                    <option value="yes" {{ $restInfo->bank_in_vn == 'yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="no" {{ $restInfo->bank_in_vn == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="country_to_go" id="country_to_go" value="{{ $restInfo->country_to_go }}" class="form-control" placeholder="Country to Go">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="school_diploma" id="school_diploma" value="{{ $restInfo->school_diploma }}" class="form-control" placeholder="School Diploma">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="original_english_legalizedFM_equalize" id="original_english_legalizedFM_equalize" value="{{ $restInfo->original_english_legalizedFM_equalize }}" class="form-control" placeholder="Original English Legalized FM Equalize">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="url" name="video_working_link" id="video_working_link" value="{{ $restInfo->video_working_link }}" class="form-control" placeholder="Video Working Link">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="visa_application_number" id="visa_application_number" value="{{ $restInfo->visa_application_number }}" class="form-control" placeholder="Visa Application Number">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" name="interview_date" id="interview_date" value="{{ $restInfo->interview_date }}" class="form-control">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="insurance_type" id="insurance_type" value="{{ $restInfo->insurance_type }}" class="form-control" placeholder="Insurance Type">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" name="insurance_expiry_date" id="insurance_expiry_date" value="{{ $restInfo->insurance_expiry_date }}" class="form-control">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" name="amount_paid" id="amount_paid" value="{{ $restInfo->amount_paid }}" class="form-control" placeholder="Amount Paid">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" name="balance_amount" id="balance_amount" value="{{ $restInfo->balance_amount }}" class="form-control" placeholder="Balance Amount">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <p>Current: {{ $restInfo->document_to_upload }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="working_place" id="working_place" value="{{ $restInfo->working_place }}" class="form-control" placeholder="Working Place">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="address_abroad" id="address_abroad" value="{{ $restInfo->address_abroad }}" class="form-control" placeholder="Address Abroad">
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="phone_abroad" id="phone_abroad" value="{{ $restInfo->phone_abroad }}" class="form-control" placeholder="Phone Abroad">
                                <p></p>
                            </div>
                        </div>
                            </div>
