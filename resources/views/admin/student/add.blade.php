...
<section class="content">
    ...
    <div class="container-fluid">
        <form class="saveForm studentForm" data-storeURL="{{ route('admin.student.store') }}">
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="full_name" id="full_name" readonly class="form-control" placeholder="Full Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="sure_name" id="sure_name" class="form-control" placeholder="Sure Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="given_name" id="given_name" class="form-control" placeholder="Given Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="dob" id="dob" readonly class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="age" id="age" readonly class="form-control" placeholder="Age">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="place_of_birth" id="place_of_birth" readonly class="form-control" placeholder="Place of Birth">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="father_name" id="father_name" readonly class="form-control" placeholder="Father's Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="mother_name" id="mother_name" readonly class="form-control" placeholder="Mother's Name">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="visa_number" id="visa_number" readonly class="form-control" placeholder="Visa Number">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="visa_issue_date" id="visa_issue_date" readonly class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="visa_expiry_date" id="visa_expiry_date" readonly class="form-control">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="agency_name" id="agency_name" readonly class="form-control" placeholder="Agency Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="agent_name" id="agent_name" readonly class="form-control" placeholder="Agent Name">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="training_program" id="training_program" readonly class="form-control" placeholder="Training Program">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="class_hours" id="class_hours" class="form-control" placeholder="Class Hours">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="practice_hours" id="practice_hours" class="form-control" placeholder="Practice Hours">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="address_in_ro" id="address_in_ro" class="form-control" placeholder="Address in RO">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="working_place_ro" id="working_place_ro" class="form-control" placeholder="Working Place in RO">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="training_place_ro" id="training_place_ro" class="form-control" placeholder="Training Place in RO">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone_number_ro" id="phone_number_ro" class="form-control" placeholder="Phone Number in RO">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="bank_account_ro" id="bank_account_ro" class="form-control" placeholder="Bank Account in RO">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="arrival_date_ro" id="arrival_date_ro" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="address_abroad" id="address_abroad" readonly class="form-control" placeholder="Address Abroad">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="working_place_abroad" id="working_place_abroad" readonly class="form-control" placeholder="Working Place Abroad">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="training_place_abroad" id="training_place_abroad" class="form-control" placeholder="Training Place Abroad">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone_abroad" id="phone_abroad" class="form-control" readonly placeholder="Phone Abroad">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="residence_permit_number" readonly id="residence_permit_number" class="form-control" placeholder="Residence Permit Number">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="residence_permit_issue_date" readonly id="residence_permit_issue_date" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="residence_permit_expiry_date" readonly id="residence_permit_expiry_date" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="training_start_date" id="training_start_date" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="remain_hours_training_class" id="remain_hours_training_class" class="form-control" placeholder="Remaining Class Hours">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="remain_hours_practice" id="remain_hours_practice" class="form-control" placeholder="Remaining Practice Hours">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="monthly_rate" id="monthly_rate" class="form-control" placeholder="Monthly Rate">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="daily_rate" id="daily_rate" class="form-control" placeholder="Daily Rate">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="month" id="month" class="form-control">
                                        ...
                                        <option value="2 - February">2 - February</option>
                                        <option value="3 - March">3 - March</option>
                                        <option value="4 - April">4 - April</option>
                                        <option value="5 - May">5 - May</option>
                                        <option value="6 - June">6 - June</option>
                                        <option value="7 - July">7 - July</option>
                                        <option value="8 - August">8 - August</option>
                                        <option value="9 - September">9 - September</option>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_work_hours" id="total_work_hours" class="form-control" placeholder="Total Work Hours">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_training_class_hours" id="total_training_class_hours" class="form-control" placeholder="Total Training Class Hours">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_practice_hours" id="total_practice_hours" class="form-control" placeholder="Total Practice Hours">
                                    <p></p>
                                </div>
                            </div>
                        </div>
